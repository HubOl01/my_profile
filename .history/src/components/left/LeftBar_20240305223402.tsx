...
const LeftBar = () => {
  return (
    ...
    <div className="card mb-4 shadow bg-white rounded" style={{
      ...
      <a title="Куличков Олег" href="https://vk.com/oleg01f">
        <img
          ...
          alt="about"
          src="https://sun9-73.userapi.com/impf/ZItaazPZG34T5LPYMY82VFOKVzaJUBjbsuIl1A/ZDzIk2nMdFA.jpg?size=1200x1600&quality=95&sign=ea813c9c2ae3f3219ce8d9585dded614&type=album"
      ...
      <div className="card-body">
        ...
        <p>
          <span className="text-format">День рождения:</span> 8 декабря 2002
        </p>
        <p>
