      ...
      <Grid container margin={2} rowGap={5}>
        {
          my_skills.map((skill) =>
            <Grid xs={6}>
              ...
              >
                <Grid container padding={2} margin: "auto",>
                    <Grid xs={8} sx={{textAlign:"left", "verticalAlign": "middle", display: "flex",
                    margin: "auto",
  justifyContent: "left",}}>{skill.name}</Grid>
                    <Grid xs={4} sx={{textAlign:"right"}}><CircularProgressWithLabel value={skill.progress * 100} /></Grid>
                </Grid>
