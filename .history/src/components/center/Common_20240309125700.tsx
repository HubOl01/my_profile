            ...
            <Grid xs={6}>
              ...
              >
                <Grid container padding={2}>
                  ...
                  <Grid xs={4} sx={{ textAlign: "right", margin: "auto", width: 200, height: 200 }}>{/* <CircularProgressWithLabel value={skill.progress * 100} /> */}
                  <CircularProgressbar value={skill.progress} maxValue={1} text={`${skill.progress * 100}%`}/>
                  </Grid>
                </Grid>
