            ...
            <Grid xs={6}>
              ...
              >
                <Grid container padding={2}>
                  ...
                  <Grid xs={4} sx={{ textAlign: "right", margin: "auto", }}>{/* <CircularProgressWithLabel value={skill.progress * 100} /> */}
                  <CircularProgressbar value={vaskill.progresslue} maxValue={1} text={`${skill.progress * 100}%`}
                  </Grid>
                </Grid>
