      ...
      <Grid container margin={2} rowGap={5}>
        {
          my_skills.map((skill) =>
            <Grid xs={6}>
              ...
              >
                <Grid container>
                    <Grid xs={6} alignSelf={"center"} sx={{textAlign:"left", "verticalAlign": "middle"}}>{skill.name}</Grid>
                    <Grid xs={6} sx={{textAlign:"right"}}><CircularProgressWithLabel value={skill.progress * 100} /></Grid>
                </Grid>
