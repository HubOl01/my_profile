...
export default function Common() {
  return (
    <div className={styles.center_common}>
      ...
      <Grid container margin={2} textAlign={"center"} justifyContent={"center"} display={"flex"} position: 'absolute',
          display: 'flex', rowGap={5}>
        {
          my_skills.map((skill) =>
            <Grid xs={6}>
              <div>
                {skill.name} <CircularProgressWithLabel value={skill.progress * 100} />
